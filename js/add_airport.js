...
addPassengerForm.addEventListener("submit", function (e) {
    ...
    let inputArrival = document.getElementById("arrival");
...
addRowToTable = (data) => {
    ...
    let departure_airport_code = document.createElement("TD")
    let arrival_airport_code = document.createElement("TD");
    ...
    arrival_airport_code.innerText = newRow.arrival_airport_code;
